...
export const diagnosticNodes: Record<string, DiagnosticNode> = {
  ...
  'las-q3': {
    ...
    options: [
      { label: 'Outside (lateral) ankle', nextNodeId: 'las-q4', highlightMuscles: ['left-soleus', 'right-soleus'], modelType: 'anterior', pin: { top: 92, left: 36 } },
      { label: 'Inside (medial) ankle', nextNodeId: 'las-medial', highlightMuscles: ['left-soleus', 'right-soleus'], modelType: 'anterior', pin: { top: 92, left: 44 } },
      { label: 'Front of ankle', nextNodeId: 'las-anterior', highlightMuscles: ['left-soleus', 'right-soleus'], modelType: 'anterior', pin: { top: 90, left: 40 } },
      { label: 'Back of ankle / Achilles area', nextNodeId: 'at-q1', highlightMuscles: ['calves'], modelType: 'posterior', pin: { top: 90, left: 40 } },
    ],
  },
  'las-q4': {
  ...
  'pfps-q2': {
    ...
    options: [
      { label: 'Around or behind the kneecap', nextNodeId: 'pfps-q3', highlightMuscles: ['knees'], modelType: 'anterior', pin: { top: 72, left: 40 } },
      { label: 'Below the kneecap (on the tendon)', nextNodeId: 'pfps-patellar-tend', highlightMuscles: ['knees'], modelType: 'anterior', pin: { top: 74, left: 40 } },
      { label: 'Outside of the knee', nextNodeId: 'pfps-itbs', highlightMuscles: ['knees'], modelType: 'anterior', pin: { top: 72, left: 35 } },
      { label: 'Inside of the knee', nextNodeId: 'pfps-medial', highlightMuscles: ['knees'], modelType: 'anterior', pin: { top: 72, left: 45 } },
    ],
  },
  'pfps-q3': {
  ...
  'pf-q2': {
    ...
    options: [
      { label: 'Under the heel (plantar surface)', nextNodeId: 'pf-q3', highlightMuscles: ['left-soleus', 'right-soleus'], modelType: 'posterior', pin: { top: 96, left: 40 } },
      { label: 'Back of heel (Achilles area)', nextNodeId: 'at-q1', highlightMuscles: ['calves'], modelType: 'posterior', pin: { top: 92, left: 40 } },
      { label: 'Arch of the foot', nextNodeId: 'pf-q3', highlightMuscles: ['left-soleus', 'right-soleus'], modelType: 'posterior', pin: { top: 94, left: 42 } },
      { label: 'Ball of the foot / toes', nextNodeId: 'pf-metatarsal', highlightMuscles: ['left-soleus', 'right-soleus'], modelType: 'posterior', pin: { top: 98, left: 40 } },
    ],
  },
  'pf-q3': {
  ...
  'te-q1': {
    ...
    options: [
      { label: 'Outside (lateral) of the elbow', nextNodeId: 'te-q2', highlightMuscles: ['forearm', 'triceps'], modelType: 'anterior', pin: { top: 35, left: 10 } },
      { label: 'Inside (medial) of the elbow', nextNodeId: 'te-medial', highlightMuscles: ['forearm', 'biceps'], modelType: 'anterior', pin: { top: 35, left: 20 } },
      { label: 'Back of the elbow', nextNodeId: 'te-posterior', highlightMuscles: ['triceps'], modelType: 'posterior', pin: { top: 35, left: 15 } },
    ],
  },
  'te-q2': {
  ...
  'gp-q1': {
    ...
    options: [
      { label: 'Inner thigh / adductor area', nextNodeId: 'gp-referral', highlightMuscles: ['adductor'], modelType: 'anterior', pin: { top: 52, left: 45 } },
      { label: 'Front of hip / crease', nextNodeId: 'gp-referral', highlightMuscles: ['abs', 'quadriceps'], modelType: 'anterior', pin: { top: 48, left: 40 } },
      { label: 'Pubic bone area', nextNodeId: 'gp-referral', highlightMuscles: ['abs'], modelType: 'anterior', pin: { top: 50, left: 50 } },
    ],
  },
  'gp-referral': {
  ...
  'mtss-q1': {
    ...
    options: [
      { label: 'Diffuse pain along inner shin (>5cm area)', nextNodeId: 'mtss-result', highlightMuscles: ['calves'], modelType: 'anterior', pin: { top: 82, left: 43 } },
  ...
  'ge-q1': { id: 'ge-q1', type: 'question', category: 'location', content: 'Is your pain on the INNER (medial) side of the elbow?',
    options: [{ label: 'Yes — inner elbow with gripping/flexion pain', nextNodeId: 'ge-result', highlightMuscles: ['forearm', 'biceps'], modelType: 'anterior', pin: { top: 35, left: 20 } }, { label: 'No — outer elbow', nextNodeId: 'te-q1', highlightMuscles: ['forearm', 'triceps'], modelType: 'posterior' }] },
  ...
  'dq-q1': { id: 'dq-q1', type: 'question', category: 'location', content: 'Is your pain at the thumb-side of the wrist, worsened by gripping or moving the thumb?',
    options: [{ label: 'Yes — radial wrist pain with thumb use', nextNodeId: 'dq-result', highlightMuscles: ['forearm'], modelType: 'anterior', pin: { top: 48, left: 10 } }, { label: 'No — different location', nextNodeId: 'no-match' }] },
  ...
  'itb-q1': { id: 'itb-q1', type: 'question', category: 'symptom', content: 'Is your pain on the OUTER (lateral) side of your knee, typically starting after a consistent distance of running?',
    options: [{ label: 'Yes — lateral knee pain at specific distance', nextNodeId: 'itb-result', highlightMuscles: ['knees', 'hamstring'], modelType: 'anterior', pin: { top: 72, left: 35 } }, { label: 'No — different pattern', nextNodeId: 'pfps-q1' }] },
  ...
  'ptend-q1': { id: 'ptend-q1', type: 'question', category: 'location', content: 'Is your pain precisely at the bottom tip of the kneecap (inferior pole of patella)?',
    options: [{ label: 'Yes — localized inferior pole pain', nextNodeId: 'ptend-result', highlightMuscles: ['knees'], modelType: 'anterior', pin: { top: 74, left: 40 } }, { label: 'Diffuse anterior knee pain', nextNodeId: 'pfps-q1', highlightMuscles: ['knees', 'quadriceps'], modelType: 'anterior' }] },
  ...
  'tsf-q2': { id: 'tsf-q2', type: 'question', category: 'location', content: 'Is the tender point on the FRONT (anterior) edge of the tibia?',
    options: [{ label: 'Yes - anterior tibial tenderness', nextNodeId: 'tsf-urgent', highlightMuscles: ['calves'], modelType: 'anterior', pin: { top: 82, left: 40 } }, { label: 'No - medial (inner) or posterior shin', nextNodeId: 'tsf-result', highlightMuscles: ['calves'], modelType: 'posterior', pin: { top: 82, left: 43 } }] },
  ...
  'gtps-q1': { id: 'gtps-q1', type: 'question', category: 'location', content: 'Is your pain on the OUTSIDE of your hip, over the bony prominence, especially when lying on that side at night?',
    options: [{ label: 'Yes - lateral hip pain, worse lying on it', nextNodeId: 'gtps-result', highlightMuscles: ['abductors', 'gluteal'], modelType: 'posterior', pin: { top: 48, left: 35 } }, { label: 'Pain in the groin, not lateral', nextNodeId: 'hoa-q1', highlightMuscles: ['adductor', 'abs'], modelType: 'anterior' }] },
  ...
  'pa-q1': { id: 'pa-q1', type: 'question', category: 'location', content: 'Is your pain on the INNER side of the shin, about 5cm BELOW the knee joint line?',
    options: [{ label: 'Yes - anteromedial tibia, below joint line', nextNodeId: 'pa-result', highlightMuscles: ['knees', 'calves'], modelType: 'anterior', pin: { top: 76, left: 43 } }, { label: 'Pain at joint line or above', nextNodeId: 'pfps-q1', highlightMuscles: ['knees'], modelType: 'anterior' }] },
  ...
  'plic-q1': { id: 'plic-q1', type: 'question', category: 'symptom', content: 'Do you feel a snapping or clicking band on the inner side of your kneecap during bending/straightening?',
    options: [{ label: 'Yes - palpable snapping band medial to patella', nextNodeId: 'plic-result', highlightMuscles: ['knees'], modelType: 'anterior', pin: { top: 72, left: 44 } }, { label: 'No snapping', nextNodeId: 'pfps-q1' }] },
  ...
  'pai-q1': { id: 'pai-q1', type: 'question', category: 'symptom', content: 'Do you have pain at the BACK of the ankle specifically when pointing your foot (plantarflexion), such as in ballet relevé or kicking?',
    options: [{ label: 'Yes - posterior ankle pain with plantarflexion', nextNodeId: 'pai-result', highlightMuscles: ['calves', 'left-soleus', 'right-soleus'], modelType: 'posterior', pin: { top: 90, left: 40 } }, { label: 'Pain elsewhere', nextNodeId: 'at-q1' }] },
